...
umain(int argc, char **argv)
{
  ...
  800039:	83 ec 2c             	sub    $0x2c,%esp
	...
	i = 0;
	if ((who = sfork()) != 0) {
  80003c:	e8 15 10 00 00       	call   801056 <sfork>
  ...
  800052:	50                   	push   %eax
  800053:	e8 18 10 00 00       	call   801070 <ipc_recv>
  ...
  8000a3:	e8 3d 10 00 00       	call   8010e5 <ipc_send>
		if (val == 10)
  ...
  8000f6:	e8 ea 0f 00 00       	call   8010e5 <ipc_send>
...
pgfault(struct UTrapframe *utf)
{
  ...
  800dc1:	f6 40 04 02          	testb  $0x2,0x4(%eax)
  800dc5:	74 7f                	je     800e46 <pgfault+0x8f>
  800dc7:	89 d8                	mov    %ebx,%eax
  800dc9:	c1 e8 0c             	shr    $0xc,%eax
  800dcc:	8b 04 85 00 00 40 ef 	mov    -0x10c00000(,%eax,4),%eax
  800dd3:	f6 c4 08             	test   $0x8,%ah
  800dd6:	74 6e                	je     800e46 <pgfault+0x8f>
  ...
  800dd8:	e8 ed fd ff ff       	call   800bca <sys_getenvid>
  ...
  800de9:	50                   	push   %eax
  800dea:	e8 19 fe ff ff       	call   800c08 <sys_page_alloc>
	if(r<0) panic("pgfault:page allocation failed %e",r);
  800def:	83 c4 10             	add    $0x10,%esp
  800df2:	85 c0                	test   %eax,%eax
  800df4:	78 64                	js     800e5a <pgfault+0xa3>
  ...
  800e0a:	e8 f6 fb ff ff       	call   800a05 <memcpy>
  ...
  800e1d:	56                   	push   %esi
  800e1e:	e8 28 fe ff ff       	call   800c4b <sys_page_map>
  800e23:	83 c4 20             	add    $0x20,%esp
  800e26:	85 c0                	test   %eax,%eax
  800e28:	78 42                	js     800e6c <pgfault+0xb5>
  ...
  800e32:	56                   	push   %esi
  800e33:	e8 55 fe ff ff       	call   800c8d <sys_page_unmap>
  800e38:	83 c4 10             	add    $0x10,%esp
  800e3b:	85 c0                	test   %eax,%eax
  800e3d:	78 41                	js     800e80 <pgfault+0xc9>
		panic("pgfault: page upmap failed\n");
       //	panic("pgfault not implemented");
}
  800e3f:	8d 65 f8             	lea    -0x8(%ebp),%esp
  800e42:	5b                   	pop    %ebx
  800e43:	5e                   	pop    %esi
  800e44:	5d                   	pop    %ebp
  800e45:	c3                   	ret    
  ...
  800e49:	68 6f 17 80 00       	push   $0x80176f
  800e4e:	6a 1e                	push   $0x1e
  800e50:	68 89 17 80 00       	push   $0x801789
  800e55:	e8 1a 03 00 00       	call   801174 <_panic>
	if(r<0) panic("pgfault:page allocation failed %e",r);
  800e5a:	50                   	push   %eax
  800e5b:	68 74 18 80 00       	push   $0x801874
  800e60:	6a 29                	push   $0x29
  800e62:	68 89 17 80 00       	push   $0x801789
  800e67:	e8 08 03 00 00       	call   801174 <_panic>
		panic("pgfault:page map failed\n");
  800e6c:	83 ec 04             	sub    $0x4,%esp
  800e6f:	68 94 17 80 00       	push   $0x801794
  800e74:	6a 2d                	push   $0x2d
  800e76:	68 89 17 80 00       	push   $0x801789
  800e7b:	e8 f4 02 00 00       	call   801174 <_panic>
		panic("pgfault: page upmap failed\n");
  800e80:	83 ec 04             	sub    $0x4,%esp
  800e83:	68 ad 17 80 00       	push   $0x8017ad
  800e88:	6a 2f                	push   $0x2f
  800e8a:	68 89 17 80 00       	push   $0x801789
  800e8f:	e8 e0 02 00 00       	call   801174 <_panic>
...
fork(void)
{
  ...
  800e9d:	68 b7 0d 80 00       	push   $0x800db7
  800ea2:	e8 13 03 00 00       	call   8011ba <set_pgfault_handler>
...
sys_exofork(void)
{
  ...
  800eb9:	78 28                	js     800ee3 <fork+0x4f>
	if(envid==0){
	  thisenv = &envs[ENVX(sys_getenvid())];
	  return 0;
	}
  ...
  800ec4:	0f 85 fb 00 00 00    	jne    800fc5 <fork+0x131>
	  thisenv = &envs[ENVX(sys_getenvid())];
  800eca:	e8 fb fc ff ff       	call   800bca <sys_getenvid>
  800ecf:	25 ff 03 00 00       	and    $0x3ff,%eax
  800ed4:	6b c0 7c             	imul   $0x7c,%eax,%eax
  800ed7:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  800edc:	a3 08 20 80 00       	mov    %eax,0x802008
	  return 0;
  800ee1:	eb 6a                	jmp    800f4d <fork+0xb9>
	if(envid<0) panic("sys_exofork failed\n");
  800ee3:	83 ec 04             	sub    $0x4,%esp
  800ee6:	68 c9 17 80 00       	push   $0x8017c9
  800eeb:	6a 70                	push   $0x70
  800eed:	68 89 17 80 00       	push   $0x801789
  800ef2:	e8 7d 02 00 00       	call   801174 <_panic>
		 panic("duppage:map02 failed %e",r);
  800ef7:	50                   	push   %eax
  800ef8:	68 f5 17 80 00       	push   $0x8017f5
  800efd:	6a 50                	push   $0x50
  800eff:	68 89 17 80 00       	push   $0x801789
  800f04:	e8 6b 02 00 00       	call   801174 <_panic>
  ...
  800f13:	ff 75 dc             	pushl  -0x24(%ebp)
  800f16:	e8 ed fc ff ff       	call   800c08 <sys_page_alloc>
  800f1b:	83 c4 10             	add    $0x10,%esp
  800f1e:	85 c0                	test   %eax,%eax
  800f20:	78 36                	js     800f58 <fork+0xc4>
		panic("fork:page alloc failed %e\n",r);

	extern void _pgfault_upcall();
	if((r = sys_env_set_pgfault_upcall(envid,_pgfault_upcall)))
  800f22:	83 ec 08             	sub    $0x8,%esp
  800f25:	68 1f 12 80 00       	push   $0x80121f
  800f2a:	ff 75 dc             	pushl  -0x24(%ebp)
  800f2d:	e8 df fd ff ff       	call   800d11 <sys_env_set_pgfault_upcall>
  800f32:	83 c4 10             	add    $0x10,%esp
  800f35:	85 c0                	test   %eax,%eax
  800f37:	75 31                	jne    800f6a <fork+0xd6>
		panic("fork:set upcall failed %e\n",r);
	if((r = sys_env_set_status(envid,ENV_RUNNABLE))<0)
  800f39:	83 ec 08             	sub    $0x8,%esp
  800f3c:	6a 02                	push   $0x2
  800f3e:	ff 75 dc             	pushl  -0x24(%ebp)
  800f41:	e8 89 fd ff ff       	call   800ccf <sys_env_set_status>
  800f46:	83 c4 10             	add    $0x10,%esp
  800f49:	85 c0                	test   %eax,%eax
  800f4b:	78 32                	js     800f7f <fork+0xeb>
		panic("fork:set status failed %e\n",r);
	return envid;
       	
}
  800f4d:	8b 45 dc             	mov    -0x24(%ebp),%eax
  ...
  800f57:	c3                   	ret    
		panic("fork:page alloc failed %e\n",r);
  800f58:	50                   	push   %eax
  800f59:	68 0d 18 80 00       	push   $0x80180d
  800f5e:	6a 7d                	push   $0x7d
  800f60:	68 89 17 80 00       	push   $0x801789
  800f65:	e8 0a 02 00 00       	call   801174 <_panic>
		panic("fork:set upcall failed %e\n",r);
  800f6a:	50                   	push   %eax
  800f6b:	68 28 18 80 00       	push   $0x801828
  800f70:	68 81 00 00 00       	push   $0x81
  800f75:	68 89 17 80 00       	push   $0x801789
  800f7a:	e8 f5 01 00 00       	call   801174 <_panic>
		panic("fork:set status failed %e\n",r);
  800f7f:	50                   	push   %eax
  800f80:	68 43 18 80 00       	push   $0x801843
  800f85:	68 83 00 00 00       	push   $0x83
  800f8a:	68 89 17 80 00       	push   $0x801789
  800f8f:	e8 e0 01 00 00       	call   801174 <_panic>
  ...
  800f9c:	57                   	push   %edi
  800f9d:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  800fa0:	50                   	push   %eax
  800fa1:	57                   	push   %edi
  800fa2:	50                   	push   %eax
  800fa3:	e8 a3 fc ff ff       	call   800c4b <sys_page_map>
  800fa8:	83 c4 20             	add    $0x20,%esp
  800fab:	85 c0                	test   %eax,%eax
  800fad:	0f 88 44 ff ff ff    	js     800ef7 <fork+0x63>
	for(addr=(uintptr_t)UTEXT; addr<USTACKTOP;addr+=PGSIZE){
  800fb3:	81 c3 00 10 00 00    	add    $0x1000,%ebx
  800fb9:	81 fb 00 e0 bf ee    	cmp    $0xeebfe000,%ebx
  800fbf:	0f 84 44 ff ff ff    	je     800f09 <fork+0x75>
	   if((uvpd[PDX(addr)]&PTE_P) && uvpt[PGNUM(addr)] & PTE_P)
  ...
  801016:	e8 30 fc ff ff       	call   800c4b <sys_page_map>
  80101b:	83 c4 20             	add    $0x20,%esp
  80101e:	85 c0                	test   %eax,%eax
  801020:	79 91                	jns    800fb3 <fork+0x11f>
  801022:	eb 20                	jmp    801044 <fork+0x1b0>
  801024:	83 ec 0c             	sub    $0xc,%esp
  801027:	68 05 08 00 00       	push   $0x805
  80102c:	57                   	push   %edi
  80102d:	ff 75 e0             	pushl  -0x20(%ebp)
  801030:	57                   	push   %edi
  801031:	ff 75 e4             	pushl  -0x1c(%ebp)
  801034:	e8 12 fc ff ff       	call   800c4b <sys_page_map>
  801039:	83 c4 20             	add    $0x20,%esp
  80103c:	85 c0                	test   %eax,%eax
  80103e:	0f 89 50 ff ff ff    	jns    800f94 <fork+0x100>
		 panic("duppage:map01 failed %e",r);
  801044:	50                   	push   %eax
  801045:	68 dd 17 80 00       	push   $0x8017dd
  80104a:	6a 4e                	push   $0x4e
  80104c:	68 89 17 80 00       	push   $0x801789
  801051:	e8 1e 01 00 00       	call   801174 <_panic>
...
sfork(void)
{
  ...
  80105c:	68 5e 18 80 00       	push   $0x80185e
  801061:	68 8c 00 00 00       	push   $0x8c
  801066:	68 89 17 80 00       	push   $0x801789
  80106b:	e8 04 01 00 00       	call   801174 <_panic>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801080:	74 3b                	je     8010bd <ipc_recv+0x4d>
	  r = sys_ipc_recv(pg);
  801082:	83 ec 0c             	sub    $0xc,%esp
  801085:	50                   	push   %eax
  801086:	e8 eb fc ff ff       	call   800d76 <sys_ipc_recv>
  80108b:	83 c4 10             	add    $0x10,%esp
	}else
	  r = sys_ipc_recv((void *)UTOP);
	if(r<0){
  80108e:	85 c0                	test   %eax,%eax
  801090:	78 3d                	js     8010cf <ipc_recv+0x5f>
	if(perm_store!=NULL){
		*perm_store = 0;
            }
        	return r;
  ...
  801094:	74 0a                	je     8010a0 <ipc_recv+0x30>
		     *from_env_store = thisenv->env_ipc_from;
  801096:	a1 08 20 80 00       	mov    0x802008,%eax
  80109b:	8b 40 74             	mov    0x74(%eax),%eax
  80109e:	89 06                	mov    %eax,(%esi)
	     if(perm_store != NULL)
  8010a0:	85 db                	test   %ebx,%ebx
  8010a2:	74 0a                	je     8010ae <ipc_recv+0x3e>
		     *perm_store = thisenv->env_ipc_perm;
  8010a4:	a1 08 20 80 00       	mov    0x802008,%eax
  8010a9:	8b 40 78             	mov    0x78(%eax),%eax
  8010ac:	89 03                	mov    %eax,(%ebx)
	     return thisenv->env_ipc_value;
  8010ae:	a1 08 20 80 00       	mov    0x802008,%eax
  8010b3:	8b 40 70             	mov    0x70(%eax),%eax
	   }
  ...
  8010c0:	68 00 00 c0 ee       	push   $0xeec00000
  8010c5:	e8 ac fc ff ff       	call   800d76 <sys_ipc_recv>
  8010ca:	83 c4 10             	add    $0x10,%esp
  8010cd:	eb bf                	jmp    80108e <ipc_recv+0x1e>
	if(from_env_store!=NULL){
  8010cf:	85 f6                	test   %esi,%esi
  8010d1:	74 06                	je     8010d9 <ipc_recv+0x69>
	  *from_env_store = 0;
  8010d3:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
	if(perm_store!=NULL){
  8010d9:	85 db                	test   %ebx,%ebx
  8010db:	74 d9                	je     8010b6 <ipc_recv+0x46>
		*perm_store = 0;
  8010dd:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  8010e3:	eb d1                	jmp    8010b6 <ipc_recv+0x46>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  8010f9:	b8 00 00 c0 ee       	mov    $0xeec00000,%eax
  8010fe:	0f 44 d8             	cmove  %eax,%ebx
	while((r=sys_ipc_try_send(to_env,val,pg,perm))<0){
  801101:	ff 75 14             	pushl  0x14(%ebp)
  801104:	53                   	push   %ebx
  801105:	56                   	push   %esi
  801106:	57                   	push   %edi
  801107:	e8 47 fc ff ff       	call   800d53 <sys_ipc_try_send>
  80110c:	83 c4 10             	add    $0x10,%esp
  80110f:	85 c0                	test   %eax,%eax
  801111:	79 20                	jns    801133 <ipc_send+0x4e>
	    if(r!=-E_IPC_NOT_RECV){
  801113:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801116:	75 07                	jne    80111f <ipc_send+0x3a>
		    panic("ipc_send:send message failed\n");
	    }
	    sys_yield();
  801118:	e8 cc fa ff ff       	call   800be9 <sys_yield>
  80111d:	eb e2                	jmp    801101 <ipc_send+0x1c>
		    panic("ipc_send:send message failed\n");
  80111f:	83 ec 04             	sub    $0x4,%esp
  801122:	68 96 18 80 00       	push   $0x801896
  801127:	6a 43                	push   $0x43
  801129:	68 b4 18 80 00       	push   $0x8018b4
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801190:	56                   	push   %esi
  801191:	50                   	push   %eax
  801192:	68 c0 18 80 00       	push   $0x8018c0
  ...
  8011a3:	e8 f7 ef ff ff       	call   80019f <vcprintf>
	cprintf("\n");
  8011a8:	c7 04 24 b2 18 80 00 	movl   $0x8018b2,(%esp)
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  8011c7:	74 0a                	je     8011d3 <set_pgfault_handler+0x19>
  ...
  8011d3:	a1 08 20 80 00       	mov    0x802008,%eax
  8011d8:	8b 40 48             	mov    0x48(%eax),%eax
  8011db:	83 ec 04             	sub    $0x4,%esp
  8011de:	6a 07                	push   $0x7
  8011e0:	68 00 f0 bf ee       	push   $0xeebff000
  8011e5:	50                   	push   %eax
  8011e6:	e8 1d fa ff ff       	call   800c08 <sys_page_alloc>
  8011eb:	83 c4 10             	add    $0x10,%esp
  8011ee:	85 c0                	test   %eax,%eax
  8011f0:	78 1b                	js     80120d <set_pgfault_handler+0x53>
		sys_env_set_pgfault_upcall(thisenv->env_id,_pgfault_upcall);
  8011f2:	a1 08 20 80 00       	mov    0x802008,%eax
  8011f7:	8b 40 48             	mov    0x48(%eax),%eax
  8011fa:	83 ec 08             	sub    $0x8,%esp
  8011fd:	68 1f 12 80 00       	push   $0x80121f
  801202:	50                   	push   %eax
  801203:	e8 09 fb ff ff       	call   800d11 <sys_env_set_pgfault_upcall>
  801208:	83 c4 10             	add    $0x10,%esp
  80120b:	eb bc                	jmp    8011c9 <set_pgfault_handler+0xf>
			panic("set_pgfault_handler %e",r);
  80120d:	50                   	push   %eax
  80120e:	68 e4 18 80 00       	push   $0x8018e4
  801213:	6a 22                	push   $0x22
  801215:	68 fb 18 80 00       	push   $0x8018fb
  80121a:	e8 55 ff ff ff       	call   801174 <_panic>
...
_pgfault_upcall:
  ...
  801227:	83 c4 04             	add    $0x4,%esp
	...
	// LAB 4: Your code here.
        movl 48(%esp), %ebp
  80122a:	8b 6c 24 30          	mov    0x30(%esp),%ebp
        subl $4, %ebp
  80122e:	83 ed 04             	sub    $0x4,%ebp
        movl %ebp, 48(%esp)
  801231:	89 6c 24 30          	mov    %ebp,0x30(%esp)
        movl 40(%esp), %eax
  801235:	8b 44 24 28          	mov    0x28(%esp),%eax
        movl %eax, (%ebp)
  801239:	89 45 00             	mov    %eax,0x0(%ebp)
