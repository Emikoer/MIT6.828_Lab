	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80024b:	e8 f0 0b 00 00       	call   800e40 <__udivdi3>
  ...
  800289:	e8 d2 0c 00 00       	call   800f60 <__umoddi3>
  80028e:	83 c4 14             	add    $0x14,%esp
  800291:	0f be 80 1c 11 80 00 	movsbl 0x80111c(%eax),%eax
  800298:	50                   	push   %eax
...
008002e5 <vprintfmt>:
{
  ...
  800331:	ff 24 85 e0 11 80 00 	jmp    *0x8011e0(,%eax,4)
  ...
  8003fd:	8b 14 85 40 13 80 00 	mov    0x801340(,%eax,4),%edx
  800404:	85 d2                	test   %edx,%edx
  800406:	74 18                	je     800420 <vprintfmt+0x13b>
				printfmt(putch, putdat, "%s", p);
  800408:	52                   	push   %edx
  800409:	68 3d 11 80 00       	push   $0x80113d
  80040e:	53                   	push   %ebx
  80040f:	56                   	push   %esi
  ...
  800420:	50                   	push   %eax
  800421:	68 34 11 80 00       	push   $0x801134
  800426:	53                   	push   %ebx
  800427:	56                   	push   %esi
  ...
  800448:	b8 2d 11 80 00       	mov    $0x80112d,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800bb1:	68 64 13 80 00       	push   $0x801364
  800bb6:	6a 23                	push   $0x23
  800bb8:	68 81 13 80 00       	push   $0x801381
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c32:	68 64 13 80 00       	push   $0x801364
  800c37:	6a 23                	push   $0x23
  800c39:	68 81 13 80 00       	push   $0x801381
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c74:	68 64 13 80 00       	push   $0x801364
  800c79:	6a 23                	push   $0x23
  800c7b:	68 81 13 80 00       	push   $0x801381
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800cb6:	68 64 13 80 00       	push   $0x801364
  800cbb:	6a 23                	push   $0x23
  800cbd:	68 81 13 80 00       	push   $0x801381
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800cf8:	68 64 13 80 00       	push   $0x801364
  800cfd:	6a 23                	push   $0x23
  800cff:	68 81 13 80 00       	push   $0x801381
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d3a:	68 64 13 80 00       	push   $0x801364
  800d3f:	6a 23                	push   $0x23
  800d41:	68 81 13 80 00       	push   $0x801381
...
sys_ipc_recv(void *dstva)
{
  ...
  800d9e:	68 64 13 80 00       	push   $0x801364
  800da3:	6a 23                	push   $0x23
  800da5:	68 81 13 80 00       	push   $0x801381
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800dc8:	a1 04 20 80 00       	mov    0x802004,%eax
  800dcd:	8b 40 48             	mov    0x48(%eax),%eax
  800dd0:	83 ec 04             	sub    $0x4,%esp
  800dd3:	6a 07                	push   $0x7
  800dd5:	68 00 f0 bf ee       	push   $0xeebff000
  800dda:	50                   	push   %eax
  800ddb:	e8 20 fe ff ff       	call   800c00 <sys_page_alloc>
  800de0:	83 c4 10             	add    $0x10,%esp
  800de3:	85 c0                	test   %eax,%eax
  800de5:	78 1b                	js     800e02 <set_pgfault_handler+0x53>
		sys_env_set_pgfault_upcall(thisenv->env_id,_pgfault_upcall);
  800de7:	a1 04 20 80 00       	mov    0x802004,%eax
  800dec:	8b 40 48             	mov    0x48(%eax),%eax
  800def:	83 ec 08             	sub    $0x8,%esp
  800df2:	68 14 0e 80 00       	push   $0x800e14
  800df7:	50                   	push   %eax
  800df8:	e8 0c ff ff ff       	call   800d09 <sys_env_set_pgfault_upcall>
  800dfd:	83 c4 10             	add    $0x10,%esp
  800e00:	eb bc                	jmp    800dbe <set_pgfault_handler+0xf>
			panic("set_pgfault_handler %e",r);
  800e02:	50                   	push   %eax
  800e03:	68 8f 13 80 00       	push   $0x80138f
  800e08:	6a 22                	push   $0x22
  800e0a:	68 a6 13 80 00       	push   $0x8013a6
  800e0f:	e8 f9 f2 ff ff       	call   80010d <_panic>

00800e14 <_pgfault_upcall>:
...
_pgfault_upcall:
  ...
  800e15:	a1 08 20 80 00       	mov    0x802008,%eax
	call *%eax
  ...
  800e1f:	8b 6c 24 30          	mov    0x30(%esp),%ebp
        subl $4, %ebp
  800e23:	83 ed 04             	sub    $0x4,%ebp
        movl %ebp, 48(%esp)
  800e26:	89 6c 24 30          	mov    %ebp,0x30(%esp)
        movl 40(%esp), %eax
  800e2a:	8b 44 24 28          	mov    0x28(%esp),%eax
        movl %eax, (%ebp)
  800e2e:	89 45 00             	mov    %eax,0x0(%ebp)
