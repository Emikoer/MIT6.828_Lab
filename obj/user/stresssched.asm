...
umain(int argc, char **argv)
{
  ...
  80003f:	bb 00 00 00 00       	mov    $0x0,%ebx
		if (fork() == 0)
  800044:	e8 76 0e 00 00       	call   800ebf <fork>
...
pgfault(struct UTrapframe *utf)
{
  ...
  800dec:	f6 40 04 02          	testb  $0x2,0x4(%eax)
  800df0:	74 7f                	je     800e71 <pgfault+0x8f>
  800df2:	89 d8                	mov    %ebx,%eax
  800df4:	c1 e8 0c             	shr    $0xc,%eax
  800df7:	8b 04 85 00 00 40 ef 	mov    -0x10c00000(,%eax,4),%eax
  800dfe:	f6 c4 08             	test   $0x8,%ah
  800e01:	74 6e                	je     800e71 <pgfault+0x8f>
  ...
  800e35:	e8 f6 fb ff ff       	call   800a30 <memcpy>
  ...
  800e48:	56                   	push   %esi
  800e49:	e8 28 fe ff ff       	call   800c76 <sys_page_map>
  800e4e:	83 c4 20             	add    $0x20,%esp
  800e51:	85 c0                	test   %eax,%eax
  800e53:	78 42                	js     800e97 <pgfault+0xb5>
  ...
  800e5d:	56                   	push   %esi
  800e5e:	e8 55 fe ff ff       	call   800cb8 <sys_page_unmap>
  800e63:	83 c4 10             	add    $0x10,%esp
  800e66:	85 c0                	test   %eax,%eax
  800e68:	78 41                	js     800eab <pgfault+0xc9>
  ...
  800e74:	68 6f 16 80 00       	push   $0x80166f
  800e79:	6a 1e                	push   $0x1e
  800e7b:	68 89 16 80 00       	push   $0x801689
  800e80:	e8 bb f2 ff ff       	call   800140 <_panic>
	if(r<0) panic("pgfault:page allocation failed %e",r);
  800e85:	50                   	push   %eax
  800e86:	68 74 17 80 00       	push   $0x801774
  800e8b:	6a 29                	push   $0x29
  800e8d:	68 89 16 80 00       	push   $0x801689
  800e92:	e8 a9 f2 ff ff       	call   800140 <_panic>
		panic("pgfault:page map failed\n");
  800e97:	83 ec 04             	sub    $0x4,%esp
  800e9a:	68 94 16 80 00       	push   $0x801694
  800e9f:	6a 2d                	push   $0x2d
  800ea1:	68 89 16 80 00       	push   $0x801689
  800ea6:	e8 95 f2 ff ff       	call   800140 <_panic>
		panic("pgfault: page upmap failed\n");
  800eab:	83 ec 04             	sub    $0x4,%esp
  800eae:	68 ad 16 80 00       	push   $0x8016ad
  800eb3:	6a 2f                	push   $0x2f
  800eb5:	68 89 16 80 00       	push   $0x801689
  800eba:	e8 81 f2 ff ff       	call   800140 <_panic>
...
fork(void)
{
  ...
  800ec8:	68 e2 0d 80 00       	push   $0x800de2
  800ecd:	e8 c9 01 00 00       	call   80109b <set_pgfault_handler>
...
sys_exofork(void)
{
	envid_t ret;
	asm volatile("int %2"
  800ed2:	b8 07 00 00 00       	mov    $0x7,%eax
  800ed7:	cd 30                	int    $0x30
  800ed9:	89 45 dc             	mov    %eax,-0x24(%ebp)
  800edc:	89 45 e0             	mov    %eax,-0x20(%ebp)
  ...
  800ee4:	78 28                	js     800f0e <fork+0x4f>
	if(envid==0){
	  thisenv = &envs[ENVX(sys_getenvid())];
	  return 0;
	}
  ...
  800ee6:	bb 00 00 80 00       	mov    $0x800000,%ebx
	if(envid==0){
  800eeb:	83 7d dc 00          	cmpl   $0x0,-0x24(%ebp)
  800eef:	0f 85 fb 00 00 00    	jne    800ff0 <fork+0x131>
	  thisenv = &envs[ENVX(sys_getenvid())];
  800ef5:	e8 fb fc ff ff       	call   800bf5 <sys_getenvid>
  800efa:	25 ff 03 00 00       	and    $0x3ff,%eax
  800eff:	6b c0 7c             	imul   $0x7c,%eax,%eax
  800f02:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  800f07:	a3 08 20 80 00       	mov    %eax,0x802008
	  return 0;
  800f0c:	eb 6a                	jmp    800f78 <fork+0xb9>
	if(envid<0) panic("sys_exofork failed\n");
  800f0e:	83 ec 04             	sub    $0x4,%esp
  800f11:	68 c9 16 80 00       	push   $0x8016c9
  800f16:	6a 70                	push   $0x70
  800f18:	68 89 16 80 00       	push   $0x801689
  800f1d:	e8 1e f2 ff ff       	call   800140 <_panic>
		 panic("duppage:map02 failed %e",r);
  800f22:	50                   	push   %eax
  800f23:	68 f5 16 80 00       	push   $0x8016f5
  800f28:	6a 50                	push   $0x50
  800f2a:	68 89 16 80 00       	push   $0x801689
  800f2f:	e8 0c f2 ff ff       	call   800140 <_panic>
  ...
  800f82:	c3                   	ret    
		panic("fork:page alloc failed %e\n",r);
  800f83:	50                   	push   %eax
  800f84:	68 0d 17 80 00       	push   $0x80170d
  800f89:	6a 7d                	push   $0x7d
  800f8b:	68 89 16 80 00       	push   $0x801689
  800f90:	e8 ab f1 ff ff       	call   800140 <_panic>
		panic("fork:set upcall failed %e\n",r);
  800f95:	50                   	push   %eax
  800f96:	68 28 17 80 00       	push   $0x801728
  800f9b:	68 81 00 00 00       	push   $0x81
  800fa0:	68 89 16 80 00       	push   $0x801689
  800fa5:	e8 96 f1 ff ff       	call   800140 <_panic>
		panic("fork:set status failed %e\n",r);
  800faa:	50                   	push   %eax
  800fab:	68 43 17 80 00       	push   $0x801743
  800fb0:	68 83 00 00 00       	push   $0x83
  800fb5:	68 89 16 80 00       	push   $0x801689
  800fba:	e8 81 f1 ff ff       	call   800140 <_panic>
  ...
  800fcc:	57                   	push   %edi
  800fcd:	50                   	push   %eax
  800fce:	e8 a3 fc ff ff       	call   800c76 <sys_page_map>
  800fd3:	83 c4 20             	add    $0x20,%esp
  800fd6:	85 c0                	test   %eax,%eax
  800fd8:	0f 88 44 ff ff ff    	js     800f22 <fork+0x63>
	for(addr=(uintptr_t)UTEXT; addr<USTACKTOP;addr+=PGSIZE){
  800fde:	81 c3 00 10 00 00    	add    $0x1000,%ebx
  800fe4:	81 fb 00 e0 bf ee    	cmp    $0xeebfe000,%ebx
  800fea:	0f 84 44 ff ff ff    	je     800f34 <fork+0x75>
	   if((uvpd[PDX(addr)]&PTE_P) && uvpt[PGNUM(addr)] & PTE_P)
  ...
  800ffe:	74 de                	je     800fde <fork+0x11f>
  801000:	89 de                	mov    %ebx,%esi
  801002:	c1 ee 0c             	shr    $0xc,%esi
  801005:	8b 04 b5 00 00 40 ef 	mov    -0x10c00000(,%esi,4),%eax
  80100c:	a8 01                	test   $0x1,%al
  80100e:	74 ce                	je     800fde <fork+0x11f>
        envid_t parent_envid = sys_getenvid();
  801010:	e8 e0 fb ff ff       	call   800bf5 <sys_getenvid>
  801015:	89 45 e4             	mov    %eax,-0x1c(%ebp)
	void *va = (void *)(pn*PGSIZE);
  801018:	89 f7                	mov    %esi,%edi
  80101a:	c1 e7 0c             	shl    $0xc,%edi
	if((uvpt[pn] & PTE_W) || (uvpt[pn] & PTE_COW)){
  80101d:	8b 04 b5 00 00 40 ef 	mov    -0x10c00000(,%esi,4),%eax
  801024:	a8 02                	test   $0x2,%al
  801026:	75 27                	jne    80104f <fork+0x190>
  801028:	8b 04 b5 00 00 40 ef 	mov    -0x10c00000(,%esi,4),%eax
  80102f:	f6 c4 08             	test   $0x8,%ah
  801032:	75 1b                	jne    80104f <fork+0x190>
	 if((r=sys_page_map(parent_envid,va,envid,va,perm))<0)
  801034:	83 ec 0c             	sub    $0xc,%esp
  801037:	6a 05                	push   $0x5
  801039:	57                   	push   %edi
  80103a:	ff 75 e0             	pushl  -0x20(%ebp)
  80103d:	57                   	push   %edi
  80103e:	ff 75 e4             	pushl  -0x1c(%ebp)
  801041:	e8 30 fc ff ff       	call   800c76 <sys_page_map>
  801046:	83 c4 20             	add    $0x20,%esp
  801049:	85 c0                	test   %eax,%eax
  80104b:	79 91                	jns    800fde <fork+0x11f>
  80104d:	eb 20                	jmp    80106f <fork+0x1b0>
  ...
  80105f:	e8 12 fc ff ff       	call   800c76 <sys_page_map>
  801064:	83 c4 20             	add    $0x20,%esp
  801067:	85 c0                	test   %eax,%eax
  801069:	0f 89 50 ff ff ff    	jns    800fbf <fork+0x100>
		 panic("duppage:map01 failed %e",r);
  80106f:	50                   	push   %eax
  801070:	68 dd 16 80 00       	push   $0x8016dd
  801075:	6a 4e                	push   $0x4e
  801077:	68 89 16 80 00       	push   $0x801689
  80107c:	e8 bf f0 ff ff       	call   800140 <_panic>
...
sfork(void)
{
  ...
  801087:	68 5e 17 80 00       	push   $0x80175e
  80108c:	68 8c 00 00 00       	push   $0x8c
  801091:	68 89 16 80 00       	push   $0x801689
  801096:	e8 a5 f0 ff ff       	call   800140 <_panic>

0080109b <set_pgfault_handler>:
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  8010a1:	83 3d 0c 20 80 00 00 	cmpl   $0x0,0x80200c
  8010a8:	74 0a                	je     8010b4 <set_pgfault_handler+0x19>
  ...
  8010ad:	a3 0c 20 80 00       	mov    %eax,0x80200c
}
  8010b2:	c9                   	leave  
  8010b3:	c3                   	ret    
		if((r=sys_page_alloc(thisenv->env_id,(void *)UXSTACKTOP-PGSIZE,PTE_P|PTE_W|PTE_U))<0)
  8010b4:	a1 08 20 80 00       	mov    0x802008,%eax
  8010b9:	8b 40 48             	mov    0x48(%eax),%eax
  8010bc:	83 ec 04             	sub    $0x4,%esp
  8010bf:	6a 07                	push   $0x7
  8010c1:	68 00 f0 bf ee       	push   $0xeebff000
  8010c6:	50                   	push   %eax
  8010c7:	e8 67 fb ff ff       	call   800c33 <sys_page_alloc>
  8010cc:	83 c4 10             	add    $0x10,%esp
  8010cf:	85 c0                	test   %eax,%eax
  8010d1:	78 1b                	js     8010ee <set_pgfault_handler+0x53>
		sys_env_set_pgfault_upcall(thisenv->env_id,_pgfault_upcall);
  8010d3:	a1 08 20 80 00       	mov    0x802008,%eax
  8010d8:	8b 40 48             	mov    0x48(%eax),%eax
  8010db:	83 ec 08             	sub    $0x8,%esp
  8010de:	68 00 11 80 00       	push   $0x801100
  8010e3:	50                   	push   %eax
  8010e4:	e8 53 fc ff ff       	call   800d3c <sys_env_set_pgfault_upcall>
  8010e9:	83 c4 10             	add    $0x10,%esp
  8010ec:	eb bc                	jmp    8010aa <set_pgfault_handler+0xf>
			panic("set_pgfault_handler %e",r);
  8010ee:	50                   	push   %eax
  8010ef:	68 98 17 80 00       	push   $0x801798
  8010f4:	6a 22                	push   $0x22
  8010f6:	68 af 17 80 00       	push   $0x8017af
  8010fb:	e8 40 f0 ff ff       	call   800140 <_panic>
...
_pgfault_upcall:
  ...
  801101:	a1 0c 20 80 00       	mov    0x80200c,%eax
	call *%eax
  ...
  80110b:	8b 6c 24 30          	mov    0x30(%esp),%ebp
        subl $4, %ebp
  80110f:	83 ed 04             	sub    $0x4,%ebp
        movl %ebp, 48(%esp)
  801112:	89 6c 24 30          	mov    %ebp,0x30(%esp)
        movl 40(%esp), %eax
  801116:	8b 44 24 28          	mov    0x28(%esp),%eax
        movl %eax, (%ebp)
  80111a:	89 45 00             	mov    %eax,0x0(%ebp)
