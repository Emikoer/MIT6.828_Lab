...
umain(int argc, char **argv)
{
  ...
  800096:	50                   	push   %eax
  800097:	e8 2e 0d 00 00       	call   800dca <ipc_send>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001f1:	e8 aa 0c 00 00       	call   800ea0 <__udivdi3>
  ...
  80022f:	e8 8c 0d 00 00       	call   800fc0 <__umoddi3>
...
sys_env_destroy(envid_t envid)
{
  ...
  800b63:	e8 f1 02 00 00       	call   800e59 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800be4:	e8 70 02 00 00       	call   800e59 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c26:	e8 2e 02 00 00       	call   800e59 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c68:	e8 ec 01 00 00       	call   800e59 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800caa:	e8 aa 01 00 00       	call   800e59 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800cec:	e8 68 01 00 00       	call   800e59 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800d50:	e8 04 01 00 00       	call   800e59 <_panic>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  800d65:	74 3b                	je     800da2 <ipc_recv+0x4d>
	  r = sys_ipc_recv(pg);
  800d67:	83 ec 0c             	sub    $0xc,%esp
  800d6a:	50                   	push   %eax
  800d6b:	e8 a4 ff ff ff       	call   800d14 <sys_ipc_recv>
  800d70:	83 c4 10             	add    $0x10,%esp
	}else
	  r = sys_ipc_recv((void *)UTOP);
	if(r<0){
  800d73:	85 c0                	test   %eax,%eax
  800d75:	78 3d                	js     800db4 <ipc_recv+0x5f>
	if(perm_store!=NULL){
		*perm_store = 0;
            }
        	return r;
  ...
  800d79:	74 0a                	je     800d85 <ipc_recv+0x30>
		     *from_env_store = thisenv->env_ipc_from;
  800d7b:	a1 04 20 80 00       	mov    0x802004,%eax
  800d80:	8b 40 74             	mov    0x74(%eax),%eax
  800d83:	89 06                	mov    %eax,(%esi)
	     if(perm_store != NULL)
  800d85:	85 db                	test   %ebx,%ebx
  800d87:	74 0a                	je     800d93 <ipc_recv+0x3e>
		     *perm_store = thisenv->env_ipc_perm;
  800d89:	a1 04 20 80 00       	mov    0x802004,%eax
  800d8e:	8b 40 78             	mov    0x78(%eax),%eax
  800d91:	89 03                	mov    %eax,(%ebx)
	     return thisenv->env_ipc_value;
  800d93:	a1 04 20 80 00       	mov    0x802004,%eax
  800d98:	8b 40 70             	mov    0x70(%eax),%eax
	   }

}
  800d9b:	8d 65 f8             	lea    -0x8(%ebp),%esp
  800d9e:	5b                   	pop    %ebx
  800d9f:	5e                   	pop    %esi
  800da0:	5d                   	pop    %ebp
  800da1:	c3                   	ret    
  ...
  800da5:	68 00 00 c0 ee       	push   $0xeec00000
  800daa:	e8 65 ff ff ff       	call   800d14 <sys_ipc_recv>
  800daf:	83 c4 10             	add    $0x10,%esp
  800db2:	eb bf                	jmp    800d73 <ipc_recv+0x1e>
	if(from_env_store!=NULL){
  800db4:	85 f6                	test   %esi,%esi
  800db6:	74 06                	je     800dbe <ipc_recv+0x69>
	  *from_env_store = 0;
  800db8:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
	if(perm_store!=NULL){
  800dbe:	85 db                	test   %ebx,%ebx
  800dc0:	74 d9                	je     800d9b <ipc_recv+0x46>
		*perm_store = 0;
  800dc2:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  800dc8:	eb d1                	jmp    800d9b <ipc_recv+0x46>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  800dde:	b8 00 00 c0 ee       	mov    $0xeec00000,%eax
  800de3:	0f 44 d8             	cmove  %eax,%ebx
	while((r=sys_ipc_try_send(to_env,val,pg,perm))<0){
  800de6:	ff 75 14             	pushl  0x14(%ebp)
  800de9:	53                   	push   %ebx
  800dea:	56                   	push   %esi
  800deb:	57                   	push   %edi
  800dec:	e8 00 ff ff ff       	call   800cf1 <sys_ipc_try_send>
  800df1:	83 c4 10             	add    $0x10,%esp
  800df4:	85 c0                	test   %eax,%eax
  800df6:	79 20                	jns    800e18 <ipc_send+0x4e>
	    if(r!=-E_IPC_NOT_RECV){
  800df8:	83 f8 f9             	cmp    $0xfffffff9,%eax
  800dfb:	75 07                	jne    800e04 <ipc_send+0x3a>
		    panic("ipc_send:send message failed\n");
	    }
	    sys_yield();
  800dfd:	e8 85 fd ff ff       	call   800b87 <sys_yield>
  800e02:	eb e2                	jmp    800de6 <ipc_send+0x1c>
		    panic("ipc_send:send message failed\n");
  800e04:	83 ec 04             	sub    $0x4,%esp
  800e07:	68 8f 13 80 00       	push   $0x80138f
  800e0c:	6a 43                	push   $0x43
  800e0e:	68 ad 13 80 00       	push   $0x8013ad
  800e13:	e8 41 00 00 00       	call   800e59 <_panic>
	}
...
ipc_find_env(enum EnvType type)
{
  ...
  800e2b:	6b d0 7c             	imul   $0x7c,%eax,%edx
  800e2e:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  800e34:	8b 52 50             	mov    0x50(%edx),%edx
  800e37:	39 ca                	cmp    %ecx,%edx
  800e39:	74 11                	je     800e4c <ipc_find_env+0x2c>
	for (i = 0; i < NENV; i++)
  800e3b:	83 c0 01             	add    $0x1,%eax
  800e3e:	3d 00 04 00 00       	cmp    $0x400,%eax
  800e43:	75 e6                	jne    800e2b <ipc_find_env+0xb>
			return envs[i].env_id;
	return 0;
  800e45:	b8 00 00 00 00       	mov    $0x0,%eax
  800e4a:	eb 0b                	jmp    800e57 <ipc_find_env+0x37>
			return envs[i].env_id;
  800e4c:	6b c0 7c             	imul   $0x7c,%eax,%eax
  800e4f:	05 00 00 c0 ee       	add    $0xeec00000,%eax
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800e5d:	53                   	push   %ebx
	...
	va_start(ap, fmt);
  800e5e:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  800e61:	8b 35 00 20 80 00    	mov    0x802000,%esi
  800e67:	e8 fc fc ff ff       	call   800b68 <sys_getenvid>
  800e6c:	83 ec 0c             	sub    $0xc,%esp
  800e6f:	ff 75 0c             	pushl  0xc(%ebp)
  800e72:	ff 75 08             	pushl  0x8(%ebp)
  800e75:	56                   	push   %esi
  800e76:	50                   	push   %eax
  800e77:	68 b8 13 80 00       	push   $0x8013b8
  800e7c:	e8 0d f3 ff ff       	call   80018e <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800e81:	83 c4 18             	add    $0x18,%esp
  800e84:	53                   	push   %ebx
  800e85:	ff 75 10             	pushl  0x10(%ebp)
  800e88:	e8 b0 f2 ff ff       	call   80013d <vcprintf>
	cprintf("\n");
  800e8d:	c7 04 24 ab 13 80 00 	movl   $0x8013ab,(%esp)
  800e94:	e8 f5 f2 ff ff       	call   80018e <cprintf>
  800e99:	83 c4 10             	add    $0x10,%esp
	...
	while (1)
		asm volatile("int3");
  800e9c:	cc                   	int3   
  800e9d:	eb fd                	jmp    800e9c <_panic+0x43>
  800e9f:	90                   	nop
