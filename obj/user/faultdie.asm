...
sys_env_destroy(envid_t envid)
{
  ...
  800b42:	e8 79 02 00 00       	call   800dc0 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800bc3:	e8 f8 01 00 00       	call   800dc0 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c05:	e8 b6 01 00 00       	call   800dc0 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c47:	e8 74 01 00 00       	call   800dc0 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c89:	e8 32 01 00 00       	call   800dc0 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800ccb:	e8 f0 00 00 00       	call   800dc0 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800d2f:	e8 8c 00 00 00       	call   800dc0 <_panic>
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800d4d:	a1 04 20 80 00       	mov    0x802004,%eax
  800d52:	8b 40 48             	mov    0x48(%eax),%eax
  800d55:	83 ec 04             	sub    $0x4,%esp
  800d58:	6a 07                	push   $0x7
  800d5a:	68 00 f0 bf ee       	push   $0xeebff000
  800d5f:	50                   	push   %eax
  800d60:	e8 20 fe ff ff       	call   800b85 <sys_page_alloc>
  800d65:	83 c4 10             	add    $0x10,%esp
  800d68:	85 c0                	test   %eax,%eax
  800d6a:	78 1b                	js     800d87 <set_pgfault_handler+0x53>
		sys_env_set_pgfault_upcall(thisenv->env_id,_pgfault_upcall);
  800d6c:	a1 04 20 80 00       	mov    0x802004,%eax
  800d71:	8b 40 48             	mov    0x48(%eax),%eax
  800d74:	83 ec 08             	sub    $0x8,%esp
  800d77:	68 99 0d 80 00       	push   $0x800d99
  800d7c:	50                   	push   %eax
  800d7d:	e8 0c ff ff ff       	call   800c8e <sys_env_set_pgfault_upcall>
  800d82:	83 c4 10             	add    $0x10,%esp
  800d85:	eb bc                	jmp    800d43 <set_pgfault_handler+0xf>
			panic("set_pgfault_handler %e",r);
  800d87:	50                   	push   %eax
  800d88:	68 ef 12 80 00       	push   $0x8012ef
  800d8d:	6a 22                	push   $0x22
  800d8f:	68 06 13 80 00       	push   $0x801306
  800d94:	e8 27 00 00 00       	call   800dc0 <_panic>
...
_pgfault_upcall:
  ...
  800da1:	83 c4 04             	add    $0x4,%esp
	...
	// LAB 4: Your code here.
        movl 48(%esp), %ebp
  800da4:	8b 6c 24 30          	mov    0x30(%esp),%ebp
        subl $4, %ebp
  800da8:	83 ed 04             	sub    $0x4,%ebp
        movl %ebp, 48(%esp)
  800dab:	89 6c 24 30          	mov    %ebp,0x30(%esp)
        movl 40(%esp), %eax
  800daf:	8b 44 24 28          	mov    0x28(%esp),%eax
        movl %eax, (%ebp)
  800db3:	89 45 00             	mov    %eax,0x0(%ebp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800dce:	e8 74 fd ff ff       	call   800b47 <sys_getenvid>
  800dd3:	83 ec 0c             	sub    $0xc,%esp
  800dd6:	ff 75 0c             	pushl  0xc(%ebp)
  800dd9:	ff 75 08             	pushl  0x8(%ebp)
  800ddc:	56                   	push   %esi
  800ddd:	50                   	push   %eax
  800dde:	68 14 13 80 00       	push   $0x801314
  800de3:	e8 85 f3 ff ff       	call   80016d <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800de8:	83 c4 18             	add    $0x18,%esp
  800deb:	53                   	push   %ebx
  800dec:	ff 75 10             	pushl  0x10(%ebp)
  800def:	e8 28 f3 ff ff       	call   80011c <vcprintf>
	cprintf("\n");
  800df4:	c7 04 24 7a 10 80 00 	movl   $0x80107a,(%esp)
  800dfb:	e8 6d f3 ff ff       	call   80016d <cprintf>
