	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800260:	e8 eb 0b 00 00       	call   800e50 <__udivdi3>
  ...
  80029e:	e8 cd 0c 00 00       	call   800f70 <__umoddi3>
  8002a3:	83 c4 14             	add    $0x14,%esp
  8002a6:	0f be 80 3c 11 80 00 	movsbl 0x80113c(%eax),%eax
  8002ad:	50                   	push   %eax
...
008002fa <vprintfmt>:
{
  ...
  80041d:	52                   	push   %edx
  80041e:	68 5d 11 80 00       	push   $0x80115d
  800423:	53                   	push   %ebx
  800424:	56                   	push   %esi
  ...
  800435:	50                   	push   %eax
  800436:	68 54 11 80 00       	push   $0x801154
  80043b:	53                   	push   %ebx
  80043c:	56                   	push   %esi
  ...
  80045d:	b8 4d 11 80 00       	mov    $0x80114d,%eax
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800ddd:	a1 04 20 80 00       	mov    0x802004,%eax
  800de2:	8b 40 48             	mov    0x48(%eax),%eax
  800de5:	83 ec 04             	sub    $0x4,%esp
  800de8:	6a 07                	push   $0x7
  800dea:	68 00 f0 bf ee       	push   $0xeebff000
  800def:	50                   	push   %eax
  800df0:	e8 20 fe ff ff       	call   800c15 <sys_page_alloc>
  800df5:	83 c4 10             	add    $0x10,%esp
  800df8:	85 c0                	test   %eax,%eax
  800dfa:	78 1b                	js     800e17 <set_pgfault_handler+0x53>
		sys_env_set_pgfault_upcall(thisenv->env_id,_pgfault_upcall);
  800dfc:	a1 04 20 80 00       	mov    0x802004,%eax
  800e01:	8b 40 48             	mov    0x48(%eax),%eax
  800e04:	83 ec 08             	sub    $0x8,%esp
  800e07:	68 29 0e 80 00       	push   $0x800e29
  800e0c:	50                   	push   %eax
  800e0d:	e8 0c ff ff ff       	call   800d1e <sys_env_set_pgfault_upcall>
  800e12:	83 c4 10             	add    $0x10,%esp
  800e15:	eb bc                	jmp    800dd3 <set_pgfault_handler+0xf>
			panic("set_pgfault_handler %e",r);
  800e17:	50                   	push   %eax
  800e18:	68 af 13 80 00       	push   $0x8013af
  800e1d:	6a 22                	push   $0x22
  800e1f:	68 c6 13 80 00       	push   $0x8013c6
  800e24:	e8 f9 f2 ff ff       	call   800122 <_panic>

00800e29 <_pgfault_upcall>:
...
_pgfault_upcall:
  ...
  800e2a:	a1 08 20 80 00       	mov    0x802008,%eax
	call *%eax
  ...
  800e31:	83 c4 04             	add    $0x4,%esp
	...
	// LAB 4: Your code here.
        movl 48(%esp), %ebp
  800e34:	8b 6c 24 30          	mov    0x30(%esp),%ebp
        subl $4, %ebp
  800e38:	83 ed 04             	sub    $0x4,%ebp
        movl %ebp, 48(%esp)
  800e3b:	89 6c 24 30          	mov    %ebp,0x30(%esp)
        movl 40(%esp), %eax
  800e3f:	8b 44 24 28          	mov    0x28(%esp),%eax
        movl %eax, (%ebp)
  800e43:	89 45 00             	mov    %eax,0x0(%ebp)
