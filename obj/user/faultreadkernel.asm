...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801555:	68 0b 22 80 00       	push   $0x80220b
  80155a:	53                   	push   %ebx
...
008015b5 <_pipeisclosed>:
{
  ...
  8015f8:	50                   	push   %eax
  8015f9:	53                   	push   %ebx
  8015fa:	68 12 22 80 00       	push   $0x802212
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  80189a:	68 2a 22 80 00       	push   $0x80222a
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801a23:	56                   	push   %esi
  801a24:	50                   	push   %eax
  801a25:	68 38 22 80 00       	push   $0x802238
  ...
  801a36:	e8 b7 e6 ff ff       	call   8000f2 <vcprintf>
	cprintf("\n");
  801a3b:	c7 04 24 23 22 80 00 	movl   $0x802223,(%esp)
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801aff:	68 5c 22 80 00       	push   $0x80225c
  801b04:	6a 43                	push   $0x43
  801b06:	68 7a 22 80 00       	push   $0x80227a
