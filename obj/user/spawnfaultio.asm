...
umain(int argc, char **argv)
{
  ...
  800068:	c3                   	ret    
		panic("spawn(faultio) failed: %e", r);
  800069:	50                   	push   %eax
  80006a:	68 26 24 80 00       	push   $0x802426
  80006f:	6a 09                	push   $0x9
  800071:	68 40 24 80 00       	push   $0x802440
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8000f7:	56                   	push   %esi
  8000f8:	50                   	push   %eax
  8000f9:	68 60 24 80 00       	push   $0x802460
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80025f:	0f be 80 83 24 80 00 	movsbl 0x802483(%eax),%eax
  800266:	50                   	push   %eax
...
008002b3 <vprintfmt>:
{
  ...
  8003ee:	50                   	push   %eax
  8003ef:	68 9b 24 80 00       	push   $0x80249b
  8003f4:	53                   	push   %ebx
  8003f5:	56                   	push   %esi
  ...
  800416:	b8 94 24 80 00       	mov    $0x802494,%eax
