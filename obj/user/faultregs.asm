	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8007bb:	0f be 80 04 17 80 00 	movsbl 0x801704(%eax),%eax
  8007c2:	50                   	push   %eax
...
0080080f <vprintfmt>:
{
  ...
  800932:	52                   	push   %edx
  800933:	68 25 17 80 00       	push   $0x801725
  800938:	53                   	push   %ebx
  800939:	56                   	push   %esi
  ...
  80094a:	50                   	push   %eax
  80094b:	68 1c 17 80 00       	push   $0x80171c
  800950:	53                   	push   %ebx
  800951:	56                   	push   %esi
  ...
  800972:	b8 15 17 80 00       	mov    $0x801715,%eax
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  8012f2:	a1 cc 20 80 00       	mov    0x8020cc,%eax
  8012f7:	8b 40 48             	mov    0x48(%eax),%eax
  8012fa:	83 ec 04             	sub    $0x4,%esp
  8012fd:	6a 07                	push   $0x7
  8012ff:	68 00 f0 bf ee       	push   $0xeebff000
  801304:	50                   	push   %eax
  801305:	e8 20 fe ff ff       	call   80112a <sys_page_alloc>
  80130a:	83 c4 10             	add    $0x10,%esp
  80130d:	85 c0                	test   %eax,%eax
  80130f:	78 1b                	js     80132c <set_pgfault_handler+0x53>
		sys_env_set_pgfault_upcall(thisenv->env_id,_pgfault_upcall);
  801311:	a1 cc 20 80 00       	mov    0x8020cc,%eax
  801316:	8b 40 48             	mov    0x48(%eax),%eax
  801319:	83 ec 08             	sub    $0x8,%esp
  80131c:	68 3e 13 80 00       	push   $0x80133e
  801321:	50                   	push   %eax
  801322:	e8 0c ff ff ff       	call   801233 <sys_env_set_pgfault_upcall>
  801327:	83 c4 10             	add    $0x10,%esp
  80132a:	eb bc                	jmp    8012e8 <set_pgfault_handler+0xf>
			panic("set_pgfault_handler %e",r);
  80132c:	50                   	push   %eax
  80132d:	68 6f 19 80 00       	push   $0x80196f
  801332:	6a 22                	push   $0x22
  801334:	68 86 19 80 00       	push   $0x801986
  801339:	e8 f9 f2 ff ff       	call   800637 <_panic>

0080133e <_pgfault_upcall>:
...
_pgfault_upcall:
  ...
  80133f:	a1 d0 20 80 00       	mov    0x8020d0,%eax
	call *%eax
  ...
  801346:	83 c4 04             	add    $0x4,%esp
	...
	// LAB 4: Your code here.
        movl 48(%esp), %ebp
  801349:	8b 6c 24 30          	mov    0x30(%esp),%ebp
        subl $4, %ebp
  80134d:	83 ed 04             	sub    $0x4,%ebp
        movl %ebp, 48(%esp)
  801350:	89 6c 24 30          	mov    %ebp,0x30(%esp)
        movl 40(%esp), %eax
  801354:	8b 44 24 28          	mov    0x28(%esp),%eax
        movl %eax, (%ebp)
  801358:	89 45 00             	mov    %eax,0x0(%ebp)
